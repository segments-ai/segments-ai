...
setup(
  ...
  version = '0.20.1',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/segments-ai/segments-ai/archive/v0.19.tar.gz',
