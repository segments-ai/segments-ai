...
setup(
  ...
  download_url = 'https://github.com/segments-ai/segments-ai/archive/v0.44.tar.gz',
  keywords = ['image', 'segmentation', 'labeling', 'vision'],   # Keywords that define your package best
  install_requires = ['numpy', 'requests', 'Pillow', 'tqdm', 'pycocotools;platform_system!="Windows"', 'pycocotools-windows;platform_system=="Windows"'],
  classifiers = [
